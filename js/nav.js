...
const SIDEBAR_LINKS = [
  ...
  { href: 'snapshot.html',    label: 'Snapshot Analysis', icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="11" width="5" height="10" rx="1"/><rect x="9.5" y="3" width="5" height="18" rx="1"/><rect x="16" y="8" width="5" height="13" rx="1"/></svg>` },
  ...
  { href: 'about.html',       label: 'About Us',    icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="10" r="7"/><path d="M8 21h8"/><path d="M9.5 21l1-2.4M14.5 21l-1-2.4"/><path d="M9 8.5A3.2 3.2 0 0 1 12 6"/></svg>` },
